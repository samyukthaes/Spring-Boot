...
public class EmployeeController {
    ...
    public List<Employee> getEmployeesByDeptAndSalary(@PathVariable String dept,@PathVariable String salary) {
        return service.getEmployeesByDeptAndSalary(dept,salary);
    }

    @GetMapping("/range/{sal1}/{sal2}")
    public List<Employee> getEmployeesBySalaryRange(@PathVariable String sal1,@PathVariable String sal2) {
